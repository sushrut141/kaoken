...
class GPT2AttentionConfig:
    ...
    def __init__(self, props):
        # Max sequence length, probably.
        self.max_position_embeddings = props['max_position_embeddings']
        # Size of embeddings.
        self.hidden_size = props['hidden_size']
        # number of attention heads.
        self.num_attention_heads = props['num_attention_heads']  
        # Flag wther to scale attention weights,, True in GPT2.
        self.scale_attn_weights = props['scale_attn_weights']
